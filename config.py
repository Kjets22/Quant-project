...
class EnvConfig:
    ...
    # Error-regime policy: force FLAT in a confirmed chop regime (the condition the
    # trend agent usually gets wrong / churns in). A dedicated "do nothing" policy.
    flat_in_chop: bool = False
    chop_gate_min_run: int = 12
